...
var Select = function(element){
    ...
    let CurriculumClone = document.querySelector("#" + element.getAttribute("option") + "ChoicesDropdownClasses").getElementsByClassName(periodEl.id)[0];
...
var Deselect = function(element){
    ...
    document.getElementById(element.getAttribute("option") + "ChoicesDropdownClasses").getElementsByClassName(periodEl.id)[0].innerHTML = "";
...
var ToggleCourseSelected = function(e){
    ...
    if (course.getAttribute("toggle") == "false"){
        ...
        var regex = RegExp('ChoicesDropdownClasses$');
        if (regex.test(course.parentElement.parentElement.id)) {
            console.log("test");
    ...
    UpdateTally();
    if (
        (document.getElementById("FirstChoicesDropdownClasses").getElementsByClassName("ClassCode").length == (CPYL.modules[qual]) + (CPYL.spins[qual])) &
        (document.getElementById("SecondChoicesDropdownClasses").getElementsByClassName("ClassCode").length == (CPYL.modules[qual]) + (CPYL.spins[qual])) &
        (document.getElementById("ThirdChoicesDropdownClasses").getElementsByClassName("ClassCode").length == (CPYL.modules[qual]) + (CPYL.spins[qual]))) {
