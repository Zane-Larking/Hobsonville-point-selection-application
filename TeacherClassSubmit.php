...
$ClassNameErr = $CoddeErr = $QualErr = $Teacher1Err = $Teacher2Err = $TypeErr = $Sub1Err = $Sub2Err = "";
...
//}
 ...
 <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
   ...
   <br><br>
   Class Code:<br> <input type="text" class="ClassandTeachers" name="email" value="<?php echo $Code;?>">
